...
/*
  ...
  Description: 
    ...
    If the model is not visible and the reticle is visible, it adds the model to the scene. 
    If the model and the reticle is visible, it moves the model to the position of the reticle. 
  Parameters: None
*/
function onSelect() {
  ...
  // if the model has not been placed
    ...
    model.visible = true; 
    scene.add(model); 
    document.getElementById("text").textContent= "Tap your screen to move the model if there is a reticle on the ground."
  }
}
